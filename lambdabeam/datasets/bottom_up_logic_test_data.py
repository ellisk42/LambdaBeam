...
python3 -m lambdabeam.datasets.bottom_up_logic_test_data \
--min_weight=5 \
--max_weight=19 \
--train_tasks_pkl_file=~/lambdabeam/logic_synthesis_10hr/train-tasks.pkl \
--output_file_format=~/lambdabeam/logic_by_weight/test-tasks-size-{}.pkl
"""
...
from lambdabeam.algorithm import baseline_enumeration
