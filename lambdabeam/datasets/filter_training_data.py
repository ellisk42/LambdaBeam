...
NUM_PROCESSES = 14
DATA_DIR = os.path.expanduser('~/lambdabeam-data/deepcoder/t-3600-maxne-5-maxni-3-skip-0.00-lambdaskip-0.00-lambdafrac-0.80')
NEW_DATA_DIR = os.path.expanduser('~/lambdabeam-data/deepcoder/t-3600-maxne-5-maxni-3-skip-0.00-lambdaskip-0.00-lambdafrac-0.80/filtered_train_data/')
