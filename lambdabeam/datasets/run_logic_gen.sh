...
data_dir=$HOME/data/lambdabeam/logic_synthesis_manual
...
python3 -m lambdabeam.datasets.data_gen \
...
data_dir=$HOME/data/lambdabeam/logic_synthesis_10hr
...
python3 -m lambdabeam.datasets.bottom_up_data_generation_logic \
