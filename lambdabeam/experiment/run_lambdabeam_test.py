...
"""Tests for lambdabeam.experiment.run_lambdabeam."""
...
from lambdabeam.algorithm import variables as variables_module
from lambdabeam.common import configs_all
from lambdabeam.datasets import data_gen
from lambdabeam.dsl import deepcoder_operations
from lambdabeam.dsl import domains
from lambdabeam.dsl import task as task_module
from lambdabeam.dsl import value as value_module
from lambdabeam.experiment import exp_common
from lambdabeam.experiment import run_lambdabeam
from lambdabeam.experiment import train_eval
...
class RunCrossBeamTest(parameterized.TestCase):
  ...
  def test_lambdabeam_memorizes(self):
    exp_common.set_global_seed(0)

    max_search_weight = 8

    args = mock.Mock()
    args.save_dir = '/tmp/lambdabeam/'
    ...
    model = run_lambdabeam.init_model(args, domain, 'deepcoder')
