...
data_folder=$HOME/data/lambdabeam/bustle/t-${tout}-maxw-${maxw}-maxne-${maxne}-maxni-${maxni}
...
save_dir=$HOME/results/lambdabeam/bustle/vw-tout-${tout}-io-${io}-value-${value}-b-${beam_size}-g-${grad_acc}
