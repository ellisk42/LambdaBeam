...
data_folder=$HOME/data/lambdabeam/logic_synthesis_dedup
...
grad_acc=4
encode_weight=True
save_dir=$HOME/results/lambdabeam/logic_synthesis/b-$beam_size-h-$hiddenunits-g-$usegreattransformer-ew-${encode_weight}
