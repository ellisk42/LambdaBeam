...
def get_config():
  ...
  cfg_dict = dict(
    ...
    num_proc=1,
    # from lambdabeam.datasets.data_gen_flags
    data_gen_seed=1,
    shard_start_index=0,
    domain='tuple',
    ...
    verbose=False,
    # from lambdabeam.experiment.exp_common
    pooling='mean',
    step_score_func='mlp',
    arg_selector='lstm',
    ...
    encode_weight=False,
    static_weight=False,
    # from lambdabeam.experiment.run_baseline_synthesizer
    eval_set_pkl=config_dict.FieldReference(None, field_type=str),
    num_eval_tasks=5,
    # from lambdabeam.experiment.run_lambdabeam
    model_type='char',
